  ...
  routes: [
    {
      ...
      children: [
        ...
        },
        {
          ...
          meta: {
            title: '英语',
            description: '英语学习路线与资料整理。',
            section: 'english',
            module: 'hub',
            breadcrumb: [{ label: '英语', to: '/english' }],
          },
        },
        {
        ...
        },
        {
          ...
          meta: {
            title: '今日单词',
            description: '按固定复习间隔完成今日单词学习。',
            robots: 'noindex,follow',
            section: 'english',
            module: 'vocabulary',
            parentPath: '/english/vocabulary',
            breadcrumb: [
              { label: '英语', to: '/english' },
              { label: '词汇', to: '/english/vocabulary' },
              { label: '今日单词' },
            ],
          },
        },
      ...
      children: [
        {
          ...
          meta: { title: '博客文章', readingProgress: true },
        },
      ],
    },
    {
      ...
      children: [
        {
          ...
          meta: { title: '作品', readingProgress: true },
        },
      ],
    },
    {
      path: '/portfolio/:slug/live',
      name: 'portfolio-live',
      component: () => import('@/views/portfolio/PortfolioLiveView.vue'),
      meta: { title: '在线访问', robots: 'noindex,follow' },
    },
    {
      ...
      children: [
        {
          ...
          meta: { title: '教程', readingProgress: true },
        },
        {
          path: ':chapterSlug',
      ...
      children: [
        ...
        },
        {
          ...
          meta: {
            ...
            section: 'english',
            module: 'grammar',
            parentPath: '/english/grammar',
            breadcrumb: [
              { label: '英语', to: '/english' },
              { label: '语法', to: '/english/grammar' },
              { label: '语法课' },
            ],
          },
        },
      ...
      children: [
        {
          ...
          meta: {
            title: '阅读中心',
            description: '分级精读：能力×主题×文体×CEFR 组织文章。',
            elementPlus: true,
            section: 'english',
            module: 'reading',
            parentPath: '/english',
        ...
        },
        {
          ...
          meta: {
            ...
            section: 'english',
            module: 'reading',
            parentPath: '/english/reading',
            breadcrumb: [
              { label: '英语', to: '/english' },
              { label: '阅读', to: '/english/reading' },
              { label: '精读文章' },
            ],
          },
        },
      ...
      children: [
        {
          ...
          meta: {
            title: '听力中心',
            description: '分层听力训练：场景×形式×能力，逐句精听。',
            elementPlus: true,
            section: 'english',
            module: 'listening',
            parentPath: '/english',
        ...
        },
        {
          ...
          meta: {
            ...
            breadcrumb: [
              { label: '英语', to: '/english' },
              { label: '听力', to: '/english/listening' },
              { label: '语音规则', to: '/english/listening/pronunciation' },
              { label: '规则详情' },
            ],
          },
        },
      ...
      children: [
        {
          ...
          component: () => import('@/views/english/WritingView.vue'),
          meta: {
            title: '写作中心',
            description: '表达训练、范文、模板与结构化写作任务。',
            elementPlus: true,
            section: 'english',
            module: 'writing',
            parentPath: '/english',
        ...
        },
        {
          ...
          component: () => import('@/views/english/WritingDetailView.vue'),
          meta: {
            title: '写作资源',
            elementPlus: true,
            readingProgress: true,
            section: 'english',
            module: 'writing',
            parentPath: '/english/writing',
            breadcrumb: [
              { label: '英语', to: '/english' },
              { label: '写作', to: '/english/writing' },
              { label: '写作资源' },
            ],
          },
        },
