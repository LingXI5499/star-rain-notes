  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          meta: { title: '英语语法课程', readingProgress: true },
        },
      ],
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          meta: { title: '精读文章', elementPlus: true, readingProgress: true },
        },
      ],
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          meta: { title: '语音规则', elementPlus: true, readingProgress: true },
        },
        {
    ...
    },
    {
      ...
      children: [
        ...
        { path: 'resources/:slug', name: 'english-writing-resource', component: () => import('@/views/english/WritingDetailView.vue'), meta: { title: '写作资源', elementPlus: true, readingProgress: true } },
        { path: 'practice/:slug', name: 'english-writing-practice', component: () => import('@/views/english/WritingDetailView.vue'), meta: { title: '写作练习', elementPlus: true, readingProgress: true } },
      ],
    },
    {
      path: '/admin/login',
