...
function coverGlyph(title: string) { return title.trim().slice(0, 1) || '文' }
...
<template>
  <section class="content-admin">
    <header class="content-admin__hero">
      <div><p class="content-admin__eyebrow">EDITORIAL FLOW · 内容时间线</p><h1>博客管理</h1><p>管理文章生命周期、标签与前台时间线展示。</p></div>
