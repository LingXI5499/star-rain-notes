...
.about-hero__identity{position:relative;z-index:2;display:grid;grid-template-columns:112px 1fr;gap:22px;align-items:center;max-width:640px}
.about-hero__portrait{width:104px;height:126px;display:grid;place-items:center;overflow:hidden;border:1px solid var(--border);border-radius:48px 48px 16px 16px;background:linear-gradient(155deg,var(--primary-soft),var(--accent-soft));box-shadow:var(--shadow-sm);backdrop-filter:blur(8px)}
