...
<template>
  <div ref="pageRoot" class="home-page">
    <section class="home-hero" aria-labelledby="home-title">
      ...
      <div class="home-hero__visual">
        ...
        <aside class="home-note">
          <span>EDITOR'S NOTE · 2026</span>
          <p>这里不是信息的仓库，而是一套持续生长的学习方法。</p>
          <small>Java 全栈 · AI Agent · 英语学习</small>
        </aside>
      </div>
    </section>
    ...
    <main class="home-content">
      <section class="home-section home-updates" data-reveal>
      ...
      <section class="home-section home-systems" data-reveal>
      ...
      <section class="home-section home-projects" data-reveal>
        ...
        <div v-if="home?.featuredProjects.length" class="home-projects__grid">
          <RouterLink v-for="(project,index) in home.featuredProjects" :key="project.id" :to="`/portfolio/${project.slug}`" class="home-project editorial-card public-interactive" :class="{ 'is-featured': index === 0 }">
      ...
      <section v-if="home?.aboutPreview" class="home-author" data-reveal>
