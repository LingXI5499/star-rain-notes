...
public class SeoContentChangeAspect {
    ...
    @Around("execution(* com.starrainnotes.site.service.SiteCommandService.updateAdminSettings(..)) || execution(* com.starrainnotes.profile.service.ProfileCommandService.update(..)) || execution(* com.starrainnotes.profile.service.ProfileCommandService.updateSelectedContent(..))")
