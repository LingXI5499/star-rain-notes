...
public class PronunciationRuleCommandService {
    ...
    @Transactional public PronunciationRuleView update(Long id, PronunciationRuleRequest request) {
        return repository.updateRule(id, request);
    }
    @Transactional public void delete(Long id) { repository.deleteRule(id); }
    @Transactional public PronunciationRuleView publish(Long id) { return repository.publishRule(id); }
    @Transactional public PronunciationRuleView withdraw(Long id) { return repository.withdrawRule(id); }
