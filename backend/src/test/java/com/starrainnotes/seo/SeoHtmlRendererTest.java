...
class SeoHtmlRendererTest {
    ...
    void rendersCanonicalMetadataSemanticBodyAndJsonLd() {
        ...
        SeoProperties properties = new SeoProperties("https://example.com", "", "/og-default.svg", false, "", false, "", "https://example.com");
        ...
        assertThat(html).contains("rel=\"canonical\" href=\"https://example.com/blog/123\"");
